...
namespace StrankyObce
{
    ...
    public class ApplicationUserManager : UserManager<User, int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<User, Role, int, UserLogin, UserRole, UserClaim>(context.Get<DataAcces.ObecContext>()));
